...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.banners, function (banner, index) {
    ...
    var m0 = _vm.getTypeText(banner.type)
    return {
      $orig: $orig,
      m0: m0,
    }
  })
  var l1 = _vm.convenienceServices.slice(0, 8)
  var l2 = _vm.notices.slice(0, 3)
  if (!_vm._isMounted) {
    ...
    _vm.e1 = function ($event, notice) {
      var _temp3 = arguments[arguments.length - 1].currentTarget.dataset,
        _temp4 = _temp3.eventParams || _temp3["event-params"],
        notice = _temp4.notice
      var _temp3, _temp4
      return _vm.goToNoticeDetail(notice)
    }
  }
...
var _default = {
  ...
  methods: {
    ...
    initBannerImages: function initBannerImages() {
      ...
      // 初始化banner图片加载状态
      this.imageLoaded = {};
      this.banners.forEach(function (banner, index) {
        _this.$set(_this.imageLoaded, index, false);
      });
    },
